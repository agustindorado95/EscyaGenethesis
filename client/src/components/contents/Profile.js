...
const Profile = ({ updateProfile, clearAlert, auth: { user, loading }, alerts }) => {
                    ...
                    <div className="card-body pt-0 pt-md-4 pointer-event-none">
                        ...
                        <div className="text-center">
                            ...
                            <div className="h5 font-weight-300">
                                注册日期：{new Date(user.timeCreated).toLocaleDateString('zh-CN', { year: 'numeric', month: 'long', day: 'numeric' })}
                            </div>
                            ...
                            {user.signature ? (
                                <Fragment>
                                    <a href="#!" className="change-signature">
                                        <i className="fas fa-signature"></i>{" "}
                                        修改签名
                                    </a>
                                    <img
                                        src="{{ url_for('static', filename='signatures/' + current_user.signature) }}"
                                        alt=""
                                        className="signature-img mt-3"
                                    ></img>
                                </Fragment>
                            ) : (
                                <a href="#!" className="change-signature">
                                    <i className="fas fa-plus"></i> 添加签名
                                </a>
                            )}
                        </div>
                    </div>
            ...
            <div className="col-xl-8 order-xl-1">
                <div className="card bg-secondary shadow">
                    ...
                    <div className="card-body">
                        ...
                        <form
                            className="is-avatar-upload-form"
                            action="{{url_for('users.avatar_change')}}"
                            method="POST"
                            encType="multipart/form-data"
                        >
                            <div className="form-group">
                                <button
                                    className="is-avatar-upload-button"
                                    type="submit"
                                >
                                    Change Avatar
                                </button>
                        ...
                        <form
                            className="is-signature-upload-form"
                            action="{{url_for('users.signature_change')}}"
                            method="POST"
                            encType="multipart/form-data"
                        >
                            <div className="form-group">
                                <button
                                    className="is-signature-upload-button"
                                    type="submit"
                                >
                                    Change Signature
                                </button>
...
export default connect(mapStateToProps, { updateProfile, clearAlert })(Profile);
